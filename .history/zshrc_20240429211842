...
export PATH="/Users/itinglight/development/flutter/bin:$PATH"
export PATH="/System/Library/PrivateFrameworks/Apple80211.framework/Versions/Current/Resources/airport:$PATH"

# pnpm
export PNPM_HOME="/Users/itinglight/Library/pnpm"
export PATH="$PNPM_HOME:$PATH"
# pnpm end
alias lg='lazygit'

alias pexec="bash ~/dotfiles/pexec.sh"
